...
<link href="assets/css/module-css/materials.css" rel="stylesheet">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                <div class="content-box p_relative d_block z_5">
                                    <span class="title-text p_relative d_block">Scrap Pickup</span>
                                    <h2 class="p_relative d_block">Your Scrap Pickup solutions</h2>
                                    <!-- <p class="p_relative d_block">Lorem ipsum dolor sit amet, consectetur adipiscing elit Turpis ridiculus tellus.</p> -->
                                    <div class="btn-box">
                                        <!-- <a href="index-2.html" class="theme-btn btn-one"><span>Read More</span></a> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="index-2.html">Dumpster Sizes</a></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="index-2.html">Waste Collection</a></h3>
                                    <!-- <p>Lorem ipsum dolor sit amet consectetur elit.</p> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="index-2.html">Pickup Schedule</a></h3>
                                    <!-- <p>Lorem ipsum dolor sit amet consectetur elit.</p> -->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="content-box pt_40 pb_150 ml_30">
                                ...
                                <div class="inner-box mb_35">
                                    <div class="single-item">
                                        ...
                                        <h3>Residential Scrap Pickup</h3>
            ...
            <div class="auto-container">
                <div class="inner-box">
                    ...
                    <div class="btn-box">
                        ...
                        <a href="index-2.html" class="theme-btn btn-two"><span>Get a Quotes</span></a>
                    </div>
                </div>
            </div>
        </section>
