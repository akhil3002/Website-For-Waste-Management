...
$err = '';
if (isset($_POST['create'], $_POST['subject'], $_POST['description'])) {
    $token = genToken();
    $subject = $_POST['subject'];
    $description = $_POST['description'];

    $db->prepare("INSERT INTO complaints (token, subject, description, created_at, created_by) VALUES ('$token', '$subject', '$description', '$current_date_time_local', '$user')")->execute();
...
<body>
    ...
    <div class="boxed_wrapper ltr">
        ...
        <section class="contact-section pt_150 pb_150 bg-dark">
            <div class="auto-container">
                <div class="row">
                    <div class="card overflow-hidde p-0">
                        ...
                        <div class="contact-middle" style="padding: 0;">
                            <form action="create-complaint.php" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body p-2"><br>
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <input type="text" name="subject" class="form-control form-control-lg" placeholder="subject" required autofocus>
                                        </div>
                                        <div class="col-md-12 mb-4">
                                            <textarea name="description" class="form-control form-control-lg" placeholder="complaint/feedback in detail" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="button" onclick="location.href = 'complaints.php';" class="btn btn-danger btn-lg pull-left me-2">CANCEL</button>
                                    <button type="submit" name="create" class="btn btn-success btn-lg pull-right">CREATE</button>
                                    <button type="reset" class="btn btn-warning btn-lg pull-right me-2">RESET</button>
