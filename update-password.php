...
if (isset($_POST['update'])) {
    ...
    $db->prepare("UPDATE users SET name = '$name', contact_no = '$contact_no', company = '$company', address = '$address' WHERE token = '$token'")->execute();
}
$stmt = $db->prepare("SELECT * FROM users WHERE token = ? LIMIT 0,1");
$stmt->bindParam(1, $token);
$stmt->execute();
            ...
            <div class="auto-container">
                ...
                <div class="card overflow-hidden">
                            <div class="card-header bg-vanblue p-2">
                                <h3 class="cw">
                                    <a href="myaccount.php" class="mr-2"><i class="fa fa-arrow-left"></i></a>
                                    UPDATE PROFILE
                                </h3>
                            </div>
                                    ...
                                    <div class="card-body p-2"><br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <label>EMAIL</label>
                                                <input type="text" class="form-control form-control-lg" value="<?php echo ($_SESSION['SESS_USER_EMAIL']); ?>" disabled>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label>NAME</label>
                                                <input type="text" name="name" class="form-control form-control-lg" placeholder="Name" value="<?php echo $user_rows['name'] ?>" required>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label>CONTACT NUMBER</label>
                                                <input type="number" name="contact_no" class="form-control form-control-lg" placeholder="Contact number" value="<?php echo $user_rows['contact_no'] ?>" required>
                                            </div>
                                            <?php if ($_SESSION['SESS_USER_TYPE'] == 'buyer') { ?>
                                                <div class="col-md-6 mb-4">
                                                    <label>COMPANY NAME</label>
                                                    <input type="text" name="company" class="form-control form-control-lg" placeholder="Contact person's name" value="<?php echo $user_rows['company'] ?>" required>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <label>ADDRESS</label>
                                                    <input type="text" name="address" class="form-control form-control-lg" placeholder="Company address" value="<?php echo $user_rows['address'] ?>" required>
                                                </div>
                                            <?php } else { ?>
                                                <input type="hidden" name="company" placeholder="Contact person's name" value="<?php echo $user_rows['company'] ?>">
                                                <input type="hidden" name="address" placeholder="Company address" value="<?php echo $user_rows['address'] ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <button type="button" onclick="location.href = 'myaccount.php';" class="btn btn-danger btn-lg pull-left mr-2">CANCEL</button>
                                        <button type="submit" name="update" class="btn btn-success btn-lg pull-right">UPDATE</button>
                                        <button type="reset" class="btn btn-warning btn-lg pull-right mr-2">RESET</button>
                                ...
                                <form action="update-password.php" method="post">
                                    <div class="card-body p-2"><br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <input type="password" name="cPassword" class="form-control form-control-lg" placeholder="Current password" required>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <input type="password" name="nPassword" class="form-control form-control-lg" placeholder="New password" required>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <input type="password" name="rPassword" class="form-control form-control-lg" placeholder="Repeat new password" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
