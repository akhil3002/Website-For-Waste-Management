...
$qry = $db->prepare("SELECT * FROM posts WHERE created_by = '$token'");
$qry->execute();
$mypost_count = $qry->rowcount();

$qry = $db->prepare("SELECT * FROM posts WHERE created_by = '$token' AND accepted = 1");
$qry->execute();
$mypost_count2 = $qry->rowcount();
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block mt-5">
                <div class="feature-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <div class="link">
                            <a href="create-post.php"><i class="icon-7"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block mt-5">
                <div class="feature-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <div class="link">
                            <a href="myposts.php"><i class="icon-7"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block mt-5">
                <div class="feature-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <h3>
                        <?php echo $mypost_count2 ?><br>
                            <a href="myposts.php?filter=accepted">ACCEPTED POSTS</a>
                        </h3>
                        <div class="link">
                            <a href="myposts.php?filter=accepted"><i class="icon-7"></i></a>
                        </div>
                    </div>
                </div>
            </div>
