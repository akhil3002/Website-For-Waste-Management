    ...
    <div class="boxed_wrapper ltr">
        ...
        <section class="contact-section pt_150 pb_150 bg-dark">
            <div class="auto-container">
                <div class="row">
                    <?php
                    if ($_SESSION['SESS_USER_TYPE'] == 'admin' || $_SESSION['SESS_USER_TYPE'] == 'buyer' || $_SESSION['SESS_USER_TYPE'] == 'vendor') {
                        $myac = $_SESSION['SESS_USER_TYPE'] . ".php";
                        include("include/myaccount/$myac");
                    } else if ($_SESSION['SESS_USER_TYPE'] == 'agent') {
                        include("include/myaccount/admin.php");
                    }
                    ?>
                </div>
            </div>
